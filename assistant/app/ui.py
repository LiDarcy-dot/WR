...
def welcome_html() -> str:
    return (
        ...
        "Группа с темами: в группе команда /topics — "
        "пройдусь по темам и напишу, как каждую понял "
        "(сообщение исчезнет через 24 часа).\n"
...
def menu_section_html(section: str) -> str:
    tips = {
        ...
        "inbox": (
            "<b>Файлы</b>\n"
            "«сейчас скину файлы, сохрани» — открою приём.\n"
            "Между файлами можно писать комментарии.\n"
            "«готово» — закрыть. «какие файлы» — список.\n"
            "Запароленный PDF: «пароль к файлу 12: secret»\n"
            "или пул: «возможные пароли a b c» — подберу сам.\n"
            "Вопрос по мануалам: «посмотри в мануалах как …»."
        ),
        "entities": (
            "<b>Свои списки</b>\n"
